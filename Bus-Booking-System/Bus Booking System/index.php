...
<body>
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo">BBS</a>
    ...
    <section id="home">
        <div id="route-search-form">
            ...
            <p class="text-center">Welcome to Bus Booking System. Login now to manage bus tickets and much more. OR, simply scroll down to check the Ticket status using Passenger Name Record (PNR number)</p>
    ...
    <div id="block">
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - &#10084;&#65039; Bus Booking System
                        </p>
        </footer>
    </div>
